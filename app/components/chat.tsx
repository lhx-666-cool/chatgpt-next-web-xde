...
function _Chat() {
  ...
  const [openFeedback, setOpenFeedback] = useState(false); // hxzzz feedback
      ...
      <Dialog
        ...
        PaperProps={{
          ...
          onSubmit: (event: React.FormEvent<HTMLFormElement>) => {
            ...
            feedbackfunc(session, feedback);
            handleCloseFeedback();
          },
        }}
      >
        <DialogTitle>{Locale.Chat.Actions.Feedback}</DialogTitle>
        <DialogContent>
          <DialogContentText>
            {Locale.Chat.Actions.FeedbackDetail}
          </DialogContentText>
          <TextField
            autoFocus
            required
                            ...
                            {message.streaming ? (
                              ...
                              /> */}
                                ...
                                <ChatAction
                                  ...
                                  icon={<LikeIcon />}
                                  onClick={() => like(session)}
                                />
                                <ChatAction
                                  text={Locale.Chat.Actions.Dislike}
                                  icon={<DislikeIcon />}
                                  onClick={() => dislike(session)}
                                />
                                <ChatAction
                                  text={Locale.Chat.Actions.Feedback}
                                  icon={<FeedbackIcon />}
